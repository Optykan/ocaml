...
let standard_library_default = "/Users/samuelyang/ocaml/_esy/default/store/s/ocaml-98cd962f/lib/ocaml"
...
let standard_runtime = "/Users/samuelyang/ocaml/_esy/default/store/s/ocaml-98cd962f/bin/ocamlrun"
let ccomp_type = "cc"
let c_compiler = "gcc -Wno-implicit-function-declaration"
let c_output_obj = "-o "
...
let mkdll, mkexe, mkmaindll =
  ...
  if Sys.os_type = "Win32" then
    try
      ...
      flexlink ^ " -maindll"
    with Not_found ->
      "gcc -Wno-implicit-function-declaration -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind", "gcc -Wno-implicit-function-declaration -O2 -fno-strict-aliasing -fwrapv -Wall -Wno-implicit-function-declaration -D_FILE_OFFSET_BITS=64 -D_REENTRANT -DCAML_NAME_SPACE   -Wl,-no_compact_unwind", "gcc -Wno-implicit-function-declaration -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind"
  else
    "gcc -Wno-implicit-function-declaration -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind", "gcc -Wno-implicit-function-declaration -O2 -fno-strict-aliasing -fwrapv -Wall -Wno-implicit-function-declaration -D_FILE_OFFSET_BITS=64 -D_REENTRANT -DCAML_NAME_SPACE   -Wl,-no_compact_unwind", "gcc -Wno-implicit-function-declaration -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind"
